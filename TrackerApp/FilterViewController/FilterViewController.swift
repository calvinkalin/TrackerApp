...
final class FilterViewController: UIViewController {
    ...
    private func initTableView() {
        tableView.register(FilterTableView.self, forCellReuseIdentifier: FilterTableView.identifier)
...
extension FilterViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        guard let cell = tableView.dequeueReusableCell(withIdentifier: FilterTableView.identifier, for: indexPath) as? FilterTableView else {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        guard let cell = tableView.cellForRow(at: indexPath) as? FilterTableView  else { return }
